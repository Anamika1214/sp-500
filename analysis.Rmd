...
In addition to ARIMA, we tried to model the data using a variety of linear and nonlinear techniques, including exonential smoothing, (Damped) Holt linear trend, cubic splines, and a feed-forward Neural Network. However, the ARIMA(1,1,0) model remained as the superior model by RMSE.
